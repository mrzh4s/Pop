          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5">
                  <p className="text-gray-500 text-sm font-medium">API Requests</p>
                  <p className="text-2xl font-semibold text-gray-900">{stats.apiRequests || 0}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5">
                  ...
                  <p className="text-2xl font-semibold text-gray-900">{stats.uptime || '99.9%'}</p>
                </div>
              </div>
            </div>
          </div>
